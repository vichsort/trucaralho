...
enum TrucoPhase { waitingTrucoResponse, playing, handFinished, gameFinished }
...
final class TrucoState implements GameState {
    ...
    String? gameWinnerTeamId,
      ...
      TrucoState(
        ...
        hands: Map.unmodifiable(
          (hands ?? this.hands).map((key, value) => MapEntry(key, List.unmodifiable(value))),
        ),
        ...
        pendingRaise: clearPendingRaise ? null : (pendingRaise ?? this.pendingRaise),
        phase: phase ?? this.phase,
        handWinnerTeamId: clearHandWinner ? null : (handWinnerTeamId ?? this.handWinnerTeamId),
  ...
  factory TrucoState.fromJson(Map<String, dynamic> json) => TrucoState(
        players: (json['players'] as List)
            .map((p) => Player.fromJson(Map<String, dynamic>.from(p as Map))).toList(),
        teams: (json['teams'] as List)
            .map((t) => Team.fromJson(Map<String, dynamic>.from(t as Map))).toList(),
        ...
        hands: (json['hands'] as Map).map(
          (k, v) => MapEntry(k as String, (v as List)
              .map((c) => Card.fromJson(Map<String, dynamic>.from(c as Map))).toList()),
        ),
        tricks: (json['tricks'] as List)
            .map((t) => Trick.fromJson(Map<String, dynamic>.from(t as Map))).toList(),
        ...
        pendingRaise: json['pendingRaise'] == null
            ? null
            : TrucoRaise.fromJson(Map<String, dynamic>.from(json['pendingRaise'] as Map)),
